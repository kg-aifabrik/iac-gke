...
# Outputs for the @@ENV@@-@@PURPOSE@@ root — surfaced to operators and the pipeline.

output "cluster_name" {
  description = "Name of the @@ENV@@-@@PURPOSE@@ cluster."
...
# The records to create at the registrar for the external gateway.
output "dns_records" {
